...
int rocket_client_init(int addr_size, int number_of_clients, const char* SERVER_IP_ADDR)
{
    ...
    // setting up client sockets
    init_socket(&master_socket, num_clients, 9002, SERVER_IP_ADDR);
    ...
    // setting up sig sockets
    init_socket(&sig_socket, num_clients, 9002 - 5353, SERVER_IP_ADDR);
